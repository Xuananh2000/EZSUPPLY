      ...
      <div class="mb-4">
        ...
        <div class="row">
          <div class="col-md-6 form-group">
            ...
            <input class="form-control" type="text" placeholder="Xuan">
          </div>
          <div class="col-md-6 form-group">
            <label>Last Name</label>
            <input class="form-control" type="text" placeholder="Ng.Anh">
          </div>
          <div class="col-md-6 form-group">
            <label>E-mail</label>
            <input class="form-control" type="text" placeholder="XuanNA@email.com">
          </div>
          <div class="col-md-6 form-group">
            <label>Mobile No</label>
            <input class="form-control" type="text" placeholder="0345678910">
          </div>
          <div class="col-md-6 form-group">
            <label>Address Line 1</label>
            <input class="form-control" type="text" placeholder="Số 15 Ngách 385">
          </div>
          <div class="col-md-6 form-group">
            <label>Address Line 2</label>
            <input class="form-control" type="text" placeholder="Ngõ 192 Lê Trọng Tấn">
          </div>
          <div class="col-md-6 form-group">
            <label>Country</label>
          ...
          <div class="col-md-6 form-group">
            <label>State</label>
            <input class="form-control" type="text" placeholder="Hoàng Mai">
          </div>
          <div class="col-md-6 form-group">
            <label>ZIP Code</label>
            <input class="form-control" type="text" placeholder="000000">
          </div>
        </div>
      </div>
    </div>
